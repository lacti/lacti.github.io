...
# from https://github.com/LawrenceWoodman/related_posts-jekyll_plugin/blob/master/_plugins/related_posts.rb
module RelatedPosts2
...
module Jekyll
  class Post
    include RelatedPosts2
    extend RelatedPosts2::ClassMethods
  end
end
